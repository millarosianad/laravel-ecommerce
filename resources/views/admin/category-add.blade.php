            ...
            <form action="{{ route('admin.category.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="name" name="name" placeholder="e.g. Samsung" class="w-full border px-4 py-2 rounded-lg outline-none focus:ring-1 focus:ring-primary" value="{{ old('name') }}" required>
                        @error('name')
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" id="status" name="status" value="1" class="w-4 h-4 text-primary rounded border-gray-300 focus:ring-primary" {{ old('status') ? 'checked' : '' }}>
